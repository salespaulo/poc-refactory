...
INSERT INTO price(base, toll, tax, board_tax, discount, insurance, other_taxes)
	VALUES(100.0, 10.0, 1.0, 2.0, 0.0, 3.0, 0.0);

INSERT INTO price(base, toll, tax, board_tax, discount, insurance, other_taxes)
	VALUES(200.0, 20.0, 2.0, 4.0, 6.0, 2.0, 3.0);

INSERT INTO price(base, toll, tax, board_tax, discount, insurance, other_taxes)
	VALUES(300.0, 10.0, 10.0, 2.0, 0.0, 3.0, 0.0);

INSERT INTO price(base, toll, tax, board_tax, discount, insurance, other_taxes)
	VALUES(400.0, 10.0, 1.0, 2.0, 0.0, 3.0, 10.0);
...
INSERT INTO pricing(name, serv_trav_id, tp_ticket, tp_seat, price_id)
	VALUES('PRICE SERV=1 TICKET=NORMAL SEAT=CONVENCIONAL PRICE=1', 1, 'NORMAL', 'SEMI-LEITO', 1);

INSERT INTO pricing(name, serv_trav_id, tp_ticket, tp_seat, price_id)
	VALUES('PRICE SERV=1 TICKET=NORMAL SEAT=CONVENCIONAL PRICE=1', 1, 'NORMAL', 'LEITO', 1);

INSERT INTO pricing(name, serv_trav_id, tp_ticket, tp_seat, price_id)
	VALUES('PRICE SERV=1 TICKET=ESTUDANTE SEAT=CONVENCIONAL PRICE=1', 1, 'ESTUDANTE', 'CONVENCIONAL', 1);

INSERT INTO pricing(name, serv_trav_id, tp_ticket, tp_seat, price_id)
	VALUES('PRICE SERV=1 TICKET=ESTUDANTE SEAT=SEMI-LEITO PRICE=1', 1, 'ESTUDANTE', 'SEMI-LEITO', 1);

INSERT INTO pricing(name, serv_trav_id, tp_ticket, tp_seat, price_id)
	VALUES('PRICE SERV=1 TICKET=ESTUDANTE SEAT=LEITO PRICE=1', 1, 'ESTUDANTE', 'LEITO', 1);
